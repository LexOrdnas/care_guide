    ...
    <div class="counter">
        ...
        <div class="row">
            <div class="col-12 col-lg-3">
                <div class="count-up">
                    <p class="counter-count display-4 text-center">08</p>
                    <h3 class="h1 text-center">Projetos</h3>
                </div>
            </div>

            <div class="col-12 col-lg-3">
                <div class="count-up">
                    <p class="counter-count display-4 text-center">700</p>
                    <h3 class="h1 text-center">Cadastros</h3>
                </div>
            </div>

            <div class="col-12 col-lg-3">
                <div class="count-up">
                    <p class="counter-count display-4 text-center">250</p>
                    <h3 class="h1 text-center">Feedback</h3>
                </div>
            </div>
